...
### 赴任 4 ~ 5 ヶ月
オーラルでも、少しずつ会話へ割って入ることができるようになりました。  
話の主題を捉えられるようになってくるので、自分の意見を投げかけることができます。  
ただし、議論が白熱すると置物のように黙るしかできない状態はまだ変わりません。

一方で、チャットツールであれば、話が盛り上がっていてもなんとか入り込めます。  
...
`will` はおそらく意志として使われています。
`otherwise` に続く文で `be going to` が使用されているのは、仮定の中では昼食は予定となっているというニュアンスを表しているのだと思います。  
すごくきれいな仮定法のサンプルだと、心に残りました。
