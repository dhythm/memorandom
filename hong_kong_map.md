...
+ [x] 渝人碼頭 Pier18
  - 火鍋
  - 綺麗めな内装で、セパレート型の鍋も選べるので人を連れていきやすい
+ [x] 米走雞Deluxe
  - 火鍋（特殊なタイプ）
+ [x] Him Kee Hot Pot
  - 火鍋
...
+ [x] Victoria peak
  - 香港の街が一望できる名所
  - ピークトラムは並ぶ
  - 複数人だとタクシーで行くのもあり（ぼったくりタクシーには注意）
+ [x] ランカイフォン
  - パリピの溜まり場
  - ウェーイウェーイ
+ [x] PMQ
...
+ [x] Lamma island
  - シーフードの有名な香港で3番目に大きい島
  - ハイキングも可能（水分はハイク前に購入必須）
+ [x] Ngong Ping 360
  - 30分にも及ぶロープウェイが見所
  - 大仏にも会えます
+ [x] Cheung Chau island
  - 海鮮料理が安く食べられる
  - ハイキングコースがあり、距離も選べる（2~3hコースから、5hコースまで）
